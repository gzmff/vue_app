    ...
    <div>
        <div class="shop-header">
            ...
            <div class="shop-content">
                ...
                <div class="header-content" @click="toggleShowShop">
            ...
            <div class="shop-header-discounts" @click="toggleShowDiscounts" v-if="info.supports"><!--异步显示,三层表达式会报错，二级结果为空对象-->
                <div class="discounts-left">
                    <div class="activity" :class="supportClasses[info.supports[0].type]">
                        <span class="content-tag">
                            <span class="mini-tag">{{info.supports[0].name}}</span><!--异步显示,三层表达式会报错，二级结果为空对象-->
                        </span>
            ...
            <transition name='fade'>
              <div class="shop-brief-modal" v-show="this.isShowShop">
            ...
            <transition name='fade'>
              <div class="activity-sheet" v-show="isShowDiscounts">
                <div class="activity-sheet-content">
                    ...
                    <div class="activity-sheet-close" @click="toggleShowDiscounts">
                        <span class="iconfont icon-close"></span>
                    </div>
                </div>
...
<script>
  ...
  export default{
    data(){
      return {
        isShowShop:false,//商家信息
        isShowDiscounts:false,//优惠
